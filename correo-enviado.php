...
// Verificar si el usuario viene de un envío exitoso
if (!isset($_SESSION['reset_success']) || !isset($_SESSION['reset_email'])) {
    header("Location: olvide-contrasena.php");
    exit();
}

// Obtener el correo y ocultarlo parcialmente
$email = $_SESSION['reset_email'];
$email_parts = explode('@', $email);
$username = $email_parts[0];
$domain = $email_parts[1];
$hidden_email = str_repeat('*', strlen($username)) . '@' . $domain;
...
<head>
    ...
    <title>Correo Enviado - Jabones DR</title>
</head>
<body>
    ...
    <section class="email-sent-section py-5">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8 col-sm-10 text-center">
                    <div class="card shadow-lg border-0 rounded">
                        <div class="card-body p-5">
                            <h2 class="mb-4">Revisa tu Correo Electrónico</h2>
                            <p class="mb-2">Hemos enviado tu nueva contraseña a ******@gmail.com.</p>
                            <p class="mb-2">Cambia tu contraseña para mayor seguridad con tu cuenta.</p>
                            <p class="mb-4">Vuelve a la página de iniciar sesión para que puedas hacer tus nuevos pedidos en nuestra página.</p>
                            <a href="login.html" class="btn btn-primary btn-email-sent">Iniciar Sesión</a>
                        </div>
                    </div>
                </div>
            </div>
