            ...
            if ($stmt->fetchColumn() == 0) {
                ...
                try {
                    ...
                    try {
                        ...
                        $mail->Password = 'tu_contrasena_de_aplicacion'; // Contraseña de aplicación
                        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
                        $mail->Port = 465;

                        // Destinatario
                        $mail->setFrom('tu_correo@gmail.com', 'Jabones DR');
                        $mail->addAddress($email);

                        // Contenido del correo
                        $reset_link = "http://localhost/resetear-contrasena.php?token=$token&email=" . urlencode($email);
                        $mail->isHTML(true);
                        $mail->Subject = 'Restablecer tu contraseña - Jabones DR';
                        $mail->Body = "
                        ...
                        ";
                        $mail->AltBody = "Copia y pega este enlace en tu navegador para restablecer tu contraseña: $reset_link";
                        ...
                        $errors[] = "No se pudo enviar el correo. Error: {$mail->ErrorInfo}";
                    }
                } catch (PDOException $e) {
                    $errors[] = "Error al generar el token: " . $e->getMessage();
                }
            }
        } catch (PDOException $e) {
            $errors[] = "Error al verificar el correo: " . $e->getMessage();
        }
    }
}
?>
...
<head>
    ...
    <title>Olvidé la Contraseña - Jabones DR</title>
</head>
<body>
                ...
                <div class="col-lg-5 col-md-7 col-sm-9">
                    <div class="card shadow-lg border-0 rounded">
                        <div class="card-body p-5">
                            <h2 class="text-center mb-4">Olvidé la Contraseña</h2>
                            <p class="text-center mb-4">Se enviará un mensaje a tu correo electrónico. Para hacer proporciones el correo electrónico registrado en tu cuenta.</p>
                            <form>
                                <div class="mb-3">
                                ...
                                <div class="d-grid mb-3">
                                    <a href="correo-enviado.html" class="btn btn-primary btn-forgot">Enviar</a>
                                </div>
                            </form>
                            <div class="text-center mt-3">
                                <p>¿No tienes una cuenta? <a href="registrarse.html" class="text-decoration-none">Crear una cuenta</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-3 py-3">
                            ...
                            <img src="imagenes/red2.jpg" style="width: 50px;" alt="Instagram">
                            <img src="imagenes/red3.jpg" style="width: 50px;" alt="Twitter">
                        </div>
                    </div>
                </div>
            </div>
